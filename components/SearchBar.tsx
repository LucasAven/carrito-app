...
export const SearchBar: FC<SearchBarProps> = ({ onOpenChange }) => {
  ...
  return (
    <div className="flex w-full justify-end">
      <button aria-hidden={open} onClick={handleOpenChange}>
        <SearchIcon
          className={cn(
      ...
      <div
        className={cn(
          ...
          open ? "duration-250 w-full" : "!w-0 duration-150",
        )}
      >
        <SearchIcon
          className={
        ...
        <input
          ...
          autoComplete="false"
          className={cn(
            "inline-block h-12 border border-gray-300 p-4 pl-12 pr-8 align-middle text-base",
            open ? "duration-250 w-full" : "!w-0 border-none !p-0 duration-150",
          )}
          name="search"
        ...
        <button
          ...
          className={
            open ? "absolute right-4 top-1/2 -translate-y-1/2" : "hidden"
          }
